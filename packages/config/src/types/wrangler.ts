...
type CustomDomainRoute = Schema.Schema.Type<
  typeof CustomDomainRouteSchema
>;
...
>;
type WranglerEnvRecord = Schema.Schema.Type<
  typeof WranglerEnvRecordSchema
>;
...
>;
type WranglerPlacement = Schema.Schema.Type<
  typeof WranglerPlacementSchema
>;
type WranglerRoute = Schema.Schema.Type<typeof WranglerRouteSchema>;
type WranglerTriggers = Schema.Schema.Type<
  typeof WranglerTriggersSchema
>;
