 ...
 * Could be extracted to @svartz/wrangler-schemas later if others want to reuse (see TODO.md).
 */
...
const WranglerConfigFieldsSchema = Schema.Struct({
  ...
  // --- Non-inheritable (must be set per env) ---
 ...
 * Top-level-only keys (keep_vars, migrations, send_metrics) apply to the worker as a whole.
